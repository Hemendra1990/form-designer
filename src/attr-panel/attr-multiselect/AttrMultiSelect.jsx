...
const AttrMultiSelect = (props) => {
    ...
    useEffect(() => {
        ...
        setStaticOptionList(currAttribute?.config?.staticOptionList || [emptyOption]);
    ...
    const getLabelValueOptions = () => {
        let labelAndValueOptions = meta?.currentElement?.ref.current?.getLabelAndValueOptions();
        console.log(labelAndValueOptions);
        setOptions(
            labelAndValueOptions || []
        );
    };
