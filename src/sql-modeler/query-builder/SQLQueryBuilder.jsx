...
const SQLQueryBuilder = (props) => {
    ...
    const getQueryAndCreateTab = (e) => {
        ...
        httpService.QUERY.getSingleCachedQueryDetails(sqlRow.sessionId, sqlRow.queryId)
            .then((res) => {
    ...
    const editSql = (e) => {
        ...
        if(editSqlQueryTabs.length > 0) {
            const sqlQueryTabIndex = editSqlQueryTabs.findIndex(tab => tab.name === e.value.name);
