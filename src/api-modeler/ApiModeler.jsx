...
const ApiModeler = forwardRef((props, ref) => {
    ...
    const footer = (
        <div>
            <Button className="p-button-warning" label="Yes" icon="pi pi-check" onClick={() => setShowApiModel(false)} />
            <Button label="No" icon="pi pi-times" onClick={() => setShowApiModel(false)} />
        </div>
    );
    return (
        <>
