...
export class ControlStyleModel {
    ...
    static GRID = [
        ...
        {label:'Header Cell', value: '.p-treetable.p-component .p-treetable-thead tr th'},
        {label:'Header First Cell', value: '.p-treetable.p-component .p-treetable-thead tr th:first-child'},
        {label:'Header Last Cell', value: '.p-treetable.p-component .p-treetable-thead tr th:last-child'},
        {label: 'Table Header Text', value: '.p-header-cell-text'},
        {label: 'Table Cells', value: '.p-treetable .p-treetable-tbody > tr > td'},
        {label: 'Table First Cells', value: '.p-treetable .p-treetable-tbody > tr > td'},
        {label: 'Table First Cells', value: '.p-treetable .p-treetable-tbody tr td:first-child'},
        {label: 'Table Last Cells', value: '.p-treetable .p-treetable-tbody tr td:last-child'},
